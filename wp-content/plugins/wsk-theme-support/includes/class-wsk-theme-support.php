...
final class WSK_Theme_Support {
	...
	public function includes() {
		...
		include_once WSKTS_ABSPATH . 'includes/class-wskts-install.php';

		/**
		 * Core.
		 */
		// Config
		include_once WSKTS_ABSPATH . 'includes/core/config/class-wskts-mime-types.php';
		include_once WSKTS_ABSPATH . 'includes/core/config/class-wskts-post-types.php';
		include_once WSKTS_ABSPATH . 'includes/core/config/class-wskts-theme-settings.php';

		// General
		// include_once WSKTS_ABSPATH . 'includes/core/general/class-wskts-company-details.php';
		// include_once WSKTS_ABSPATH . 'includes/core/general/class-wskts-contact-details.php';
		// include_once WSKTS_ABSPATH . 'includes/core/general/class-wskts-social-networks.php';

		// UI Shell
		include_once WSKTS_ABSPATH . 'includes/core/ui-shell/class-wskts-favicons.php';

		// Utilities
		include_once WSKTS_ABSPATH . 'includes/core/utilities/class-wskts-svg.php';
		include_once WSKTS_ABSPATH . 'includes/core/utilities/wskts-dom-functions.php';
		include_once WSKTS_ABSPATH . 'includes/core/utilities/wskts-svg-functions.php';

		/**
		 * Features.
		 */
		// include_once WSKTS_ABSPATH . 'includes/features/class-wskts-career.php';
		// include_once WSKTS_ABSPATH . 'includes/features/class-wskts-case-study.php';
		// include_once WSKTS_ABSPATH . 'includes/features/class-wskts-service.php';
		// include_once WSKTS_ABSPATH . 'includes/features/class-wskts-team.php';

		/**
		 * Integrations.
		 */
		// include_once WSKTS_ABSPATH . 'includes/integrations/class-wskts-google.php';
	}
